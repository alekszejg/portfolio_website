...
export default function ExpertiseSection({ wrapperStyling }: {wrapperStyling: string}) {
    const styling = {
        ...
        skills: {
            wrapper: "flex flex-col items-center gap-y-20 w-full py-cvSectionYGap px-[15%] bg-cvSkillsSection group tablet:gap-y-16 tablet:px-[8%] tablet:box-border tablet:hover:bg-cvSkillsHover cvUltrawide:flex-row cvUltrawide:gap-x-10 cvUltrawide:items-start",
    ...
    const technicalSkillsProps = {
        ...
        headerWrapperClass: "sticky sticky top-0 z-50 bg-cvSkillsSection tablet:h-[55px] tablet:group-hover:bg-cvSkillsHover",
    ...
    const softSkillsProps = {
        ...
        headerWrapperClass: "tablet:h-[55px]",
        headerClass: styling.skills.header,
        header: "Soft Skills",
        infoListClass: styling.approaches.list,
